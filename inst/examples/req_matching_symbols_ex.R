...
# Print a few more search strings. Wait 3 seconds after each one so as to be
# kind to IB's servers.
...
# functions with the end result of returning the asset types info you want in a
# character vector:
req_matching_symbols("ibm") %>%
